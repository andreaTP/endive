...
final class EmitterMap {
    ...
    private static final Emitters.Builder BUILDER = buildAll();

    public static final Map<CompilerOpCode, Emitters.BytecodeEmitter> EMITTERS = BUILDER.build();

    public static final Map<CompilerOpCode, Emitters.TempSlotCalculator> TEMP_SLOT_CALCULATORS =
            BUILDER.buildCalculators();

    @SuppressWarnings("checkstyle:MethodLength")
    private static Emitters.Builder buildAll() {
        return Emitters.builder()
                // ====== Misc ======
                .intrinsic(
                ...
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_STORE_SHORT, Emitters::ATOMIC_LONG_STORE_SHORT)
                ...
                .intrinsic(
                        CompilerOpCode.ATOMIC_INT_RMW16_XCHG_U, Emitters::ATOMIC_INT_RMW16_XCHG_U)
                .intrinsic(
                ...
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW_CMPXCHG, Emitters::ATOMIC_LONG_RMW_CMPXCHG)
                ...
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW8_XCHG_U, Emitters::ATOMIC_LONG_RMW8_XCHG_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW8_CMPXCHG_U,
                        Emitters::ATOMIC_LONG_RMW8_CMPXCHG_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW16_ADD_U, Emitters::ATOMIC_LONG_RMW16_ADD_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW16_SUB_U, Emitters::ATOMIC_LONG_RMW16_SUB_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW16_AND_U, Emitters::ATOMIC_LONG_RMW16_AND_U)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW16_OR_U, Emitters::ATOMIC_LONG_RMW16_OR_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW16_XOR_U, Emitters::ATOMIC_LONG_RMW16_XOR_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW16_XCHG_U, Emitters::ATOMIC_LONG_RMW16_XCHG_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW16_CMPXCHG_U,
                        Emitters::ATOMIC_LONG_RMW16_CMPXCHG_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW32_ADD_U, Emitters::ATOMIC_LONG_RMW32_ADD_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW32_SUB_U, Emitters::ATOMIC_LONG_RMW32_SUB_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW32_AND_U, Emitters::ATOMIC_LONG_RMW32_AND_U)
                .intrinsic(CompilerOpCode.ATOMIC_LONG_RMW32_OR_U, Emitters::ATOMIC_LONG_RMW32_OR_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW32_XOR_U, Emitters::ATOMIC_LONG_RMW32_XOR_U)
                .intrinsic(
                        CompilerOpCode.ATOMIC_LONG_RMW32_XCHG_U, Emitters::ATOMIC_LONG_RMW32_XCHG_U)
                .intrinsic(
